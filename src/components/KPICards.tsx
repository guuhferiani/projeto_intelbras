    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
      ...
      <div className="glass-card glass-card-hover p-4 relative overflow-hidden group">
        ...
        <div className="flex items-center justify-between mb-2">
          <span className="text-xs font-semibold text-[var(--text-secondary)] uppercase tracking-wider">Faturamento Total</span>
        ...
        <div className="flex items-center justify-between text-xs pt-1 border-t border-[var(--border-highlight)]">
          ...
          <span className="text-[11px] text-[var(--text-secondary)]">Histórico</span>
        </div>
      </div>
      ...
      <div className="glass-card glass-card-hover p-4 relative overflow-hidden group">
        ...
        <div className="flex items-center justify-between mb-2">
          <span className="text-xs font-semibold text-[var(--text-secondary)] uppercase tracking-wider">Atingimento de Meta</span>
        ...
        <div className="flex items-center justify-between text-xs pt-1 border-t border-[var(--border-highlight)] text-[var(--text-secondary)]">
          <span>Meta: <strong className="text-[var(--text-primary)]">{formatCurrency(kpis.metaTotal)}</strong></span>
        </div>
      </div>
      ...
      <div className="glass-card glass-card-hover p-4 relative overflow-hidden group">
        ...
        <div className="flex items-center justify-between mb-2">
          <span className="text-xs font-semibold text-[var(--text-secondary)] uppercase tracking-wider">Margem Bruta Média</span>
      ...
      <div className="glass-card glass-card-hover p-4 relative overflow-hidden group">
        ...
        <div className="flex items-center justify-between mb-2">
          <span className="text-xs font-semibold text-[var(--text-secondary)] uppercase tracking-wider">Ticket Médio / Venda</span>
        ...
        <div className="flex items-center justify-between text-xs pt-1 border-t border-[var(--border-highlight)] text-[var(--text-secondary)]">
          <span>Itens Vendidos: <strong className="text-[var(--text-primary)]">{formatNumber(kpis.produtosVendidos)} un</strong></span>
        </div>
      </div>
      ...
      <div className="glass-card glass-card-hover p-4 relative overflow-hidden group">
        ...
        <div className="flex items-center justify-between mb-2">
          <span className="text-xs font-semibold text-[var(--text-secondary)] uppercase tracking-wider">Pedidos & Clientes</span>
          <div className="w-8 h-8 rounded-lg bg-cyan-500/15 text-cyan-400 flex items-center justify-center">
            <ShoppingBag className="w-4 h-4" />
          </div>
        </div>
        <div className="text-2xl font-black text-[var(--text-primary)] tracking-tight mb-1">
          {formatNumber(kpis.volumePedidos)} <span className="text-xs font-normal text-[var(--text-secondary)]">pedidos</span>
        </div>
        <div className="flex items-center justify-between text-xs pt-1 border-t border-[var(--border-highlight)] text-[var(--text-secondary)]">
          <div className="flex items-center gap-1">
            <Users className="w-3.5 h-3.5 text-cyan-400" />
            <span><strong className="text-[var(--text-primary)]">{kpis.clientesUnicos}</strong> clientes ativos</span>
          </div>
        </div>
      </div>
