      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3.5">
        ...
        <div className="glass-card glass-card-hover p-4 relative overflow-hidden group">
          ...
          <div className="flex items-center justify-between mb-1.5">
            <span className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Total Realizado</span>
        ...
        <div className="glass-card glass-card-hover p-4 relative overflow-hidden group">
          ...
          <div className="flex items-center justify-between mb-1.5">
            <span className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Bolsas de Estudo</span>
        ...
        <div className="glass-card glass-card-hover p-4 relative overflow-hidden group">
          ...
          <div className="flex items-center justify-between mb-1.5">
            <span className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Ajuda de Custo</span>
        ...
        <div className="glass-card glass-card-hover p-4 relative overflow-hidden group">
          ...
          <div className="flex items-center justify-between mb-1.5">
            <span className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Descontos Faltas</span>
        ...
        <div className="glass-card glass-card-hover p-4 relative overflow-hidden group">
          ...
          <div className="flex items-center justify-between mb-1.5">
            <span className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Beneficiados</span>
            <div className="w-7 h-7 rounded-lg bg-amber-500/15 text-amber-400 flex items-center justify-center">
              <Users className="w-4 h-4" />
            </div>
          </div>
          <div className="text-2xl font-black text-amber-300 tracking-tight">
            {kpis.alunosBeneficiados} <span className="text-xs font-normal text-gray-400">alunos</span>
          </div>
          <div className="text-[11px] text-gray-400 mt-1">
        ...
        <div className="glass-card glass-card-hover p-4 relative overflow-hidden group">
          ...
          <div className="flex items-center justify-between mb-1.5">
            <span className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Investimento / Aluno</span>
        ...
        <div className="glass-card p-5">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p className="text-xs text-gray-400">Comparativo entre Realizado, Bolsas e Ajuda de Custo</p>
            </div>
          </div>
          <div className="h-72">
        ...
        <div className="glass-card p-5">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p className="text-xs text-gray-400">Proporção entre Bolsas, Ajuda de Custo e Descontos</p>
            </div>
          </div>
          <div className="h-72">
        ...
        <div className="glass-card p-5">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p className="text-xs text-gray-400">Valores retidos por datas com ausência registrada</p>
            </div>
          </div>
          <div className="h-72">
        ...
        <div className="glass-card p-5">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p className="text-xs text-gray-400">Total acumulado de valores realizados por aluno</p>
            </div>
          </div>
          <div className="h-72">
          ...
          <table className="w-full text-left text-xs border-collapse">
            <thead>
              <tr className="border-b border-white/10 text-gray-400 font-semibold bg-white/5">
                ...
                <th onClick={() => handleSort('dataProgramada')} className="p-2.5 cursor-pointer hover:text-white">Data Prog.</th>
                <th onClick={() => handleSort('bolsa')} className="p-2.5 cursor-pointer hover:text-white text-right">Bolsa</th>
                <th onClick={() => handleSort('ajudaCusto')} className="p-2.5 cursor-pointer hover:text-white text-right">Ajuda Custo</th>
                <th onClick={() => handleSort('desconto')} className="p-2.5 cursor-pointer hover:text-white text-right">Desconto</th>
                <th className="p-2.5">Observação / Falta</th>
                <th onClick={() => handleSort('realizado')} className="p-2.5 cursor-pointer hover:text-white text-right">Realizado Líquido</th>
              </tr>
            </thead>
              ...
              {paginatedRecords.map((r) => {
                return (
                  <tr key={r.id} className="hover:bg-white/5 transition-colors">
                    ...
                    <td className="p-2.5 text-gray-300 font-mono text-[11px]">{r.dataProgramada}</td>
                    ...
                    <td className="p-2.5 text-right font-mono">
                      {r.desconto > 0 ? (
                        <span className="text-rose-400 font-bold">-{formatCurrency(r.desconto)}</span>
                      ) : (
                        <span className="text-gray-500">R$ 0,00</span>
                      )}
                    </td>
                    <td className="p-2.5 text-gray-400 text-[11px] max-w-xs truncate" title={r.notaDesconto}>
                      {r.notaDesconto !== '-' ? (
